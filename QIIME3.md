...
```
nano compar_div_even5000/binary_sorensen_dice_otu_table_mc2_w_tax_even5000.txt
```
...
```
nano compar_div_even5000_PCoA/pcoa_bray_curtis_otu_table_mc2_w_tax_even5000.txt
```
...
head NMDS_Plot/mc2_even5000_braycurtis_NMDS_coords.txt
```
...
```
biom convert -i otu_table_mc2_w_tax_even5000_CollapseReps.biom -o otu_table_mc2_w_tax_even5000_CollapseReps.txt --table-type "OTU table" --to-tsv --header-key taxonomy --output-metadata-id "ConsensusLineage"
```
